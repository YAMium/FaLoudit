...
2. Скачайте `faloudit-codex-project-<версия>.zip`, например `faloudit-codex-project-0.4.1.zip`.
...
Индекс хранит поля локализации, сохранённый исходник скриптов и проверенные
строковые GameSettings. Исходные значения движка извлекаются чтением из
...
Статическое совпадение в скрипте доказывает наличие текста, но не выполнение
кода во время игры. Произвольные строки EXE вне каталога GameSettings,
